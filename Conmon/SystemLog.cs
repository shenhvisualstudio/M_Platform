...
namespace ServiceInterface.Common
{
    ...
    public class SystemLog
    {
        ...
        /// 初始化系统日志数据
        /// </summary>
        public SystemLog(HttpRequest Request)
        {
        ...
        {
            string strSql =
                    string.Format(@"insert into TB_APP_SYSTEMLOG (code_user,appname,devicetype,ip,behavior,result,remark,behaviorurl,account)
